...
//
//            org.opencv.core.Mat img = (org.opencv.core.Mat) frame.opaque;// 从frame中直接获取Mat
//
//            org.opencv.core.Mat grayImg = new org.opencv.core.Mat();//存放灰度图
...
//                rectangle(img, face_i, new opencv_core.Scalar(0, 255, 0, 1));
//
